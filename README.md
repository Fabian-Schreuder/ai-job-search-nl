...
An AI-powered job application framework for the Dutch market, built on [Claude Code](https://claude.com/claude-code). Fork it, fill in your profile, and let Claude evaluate job postings, tailor your CV, write cover letters, and prepare you for interviews.
...
A structured workflow that turns Claude Code into a full-stack job application assistant. The core workflow (self-profiling, fit evaluation, and the drafter-reviewer application pipeline) is **language- and country-agnostic**. This Dutch-market fork enables Nationale Vacaturebank, LinkedIn, and freehire sources by default; the Danish portal skills are retained as demos but disabled by default.
...
```bash
/apply https://www.nationalevacaturebank.nl/vacature/<vacancy-slug>
```
...
To add a portal for another market, run:
...
This repository is a Dutch-market fork. If you maintain your own market- or language-specific fork, announce it in the [Community forks & adaptations](https://github.com/MadsLorentzen/ai-job-search/discussions/78) discussion so others can find it.

The country-agnostic portal skills are available alongside the Dutch source:
